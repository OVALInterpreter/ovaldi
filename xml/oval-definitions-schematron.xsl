...
<xsl:choose>
   ...
   <!--PATTERN oval-def_allowed-variable-datatypes-->
	...
	<!--RULE -->
<xsl:template match="oval-def:variables/child::*" priority="1000" mode="M41">
...
<xsl:choose>
   ...
   <!--PATTERN oval-def_literal_component-->
	...
	<!--RULE -->
<xsl:template match="oval-def:literal_component" priority="1000" mode="M42">
...
<xsl:choose>
   ...
   <!--PATTERN oval-def_beginfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:begin/oval-def:literal_component" priority="1001" mode="M44">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="oval-def:begin/oval-def:variable_component" priority="1000" mode="M44">
      <xsl:variable name="var_ref" select="@var_ref"/>
...
<xsl:choose>
   ...
   <!--PATTERN oval-def_concatfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:concat/oval-def:literal_component" priority="1001" mode="M45">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="oval-def:concat/oval-def:variable_component" priority="1000" mode="M45">
      <xsl:variable name="var_ref" select="@var_ref"/>
...
<xsl:choose>
   ...
   <!--PATTERN oval-def_endfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:end/oval-def:literal_component" priority="1001" mode="M46">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="oval-def:end/oval-def:variable_component" priority="1000" mode="M46">
      <xsl:variable name="var_ref" select="@var_ref"/>
...
<xsl:choose>
   ...
   <!--PATTERN oval-def_splitfunctionrules-->
	...
	<!--RULE -->
<xsl:template match="oval-def:split/oval-def:literal_component" priority="1001" mode="M48">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="oval-def:split/oval-def:variable_component" priority="1000" mode="M48">
      <xsl:variable name="var_ref" select="@var_ref"/>
...
<xsl:choose>
   ...
   <!--PATTERN oval-def_state_record_fields-->
	...
	<!--RULE -->
<xsl:template match="oval-def:states/*/*/*" priority="1000" mode="M57">
...
<xsl:choose>
         ...
         <xsl:otherwise>
                            <xsl:text/>
            <xsl:value-of select="../@id"/>
            <xsl:text/> - datatype attribute for the <xsl:text/>
            <xsl:value-of select="name()"/>
            <xsl:text/> field of an <xsl:text/>
            <xsl:value-of select="name(../..)"/>
            <xsl:text/> should not be 'record'.
                        <xsl:value-of select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M57"/>
   ...
   <!--PATTERN ind-def_famtst-->
	...
	<!--RULE -->
<xsl:template match="ind-def:family_test/ind-def:object" priority="1001" mode="M58">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:family_test/ind-def:state" priority="1000" mode="M58">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_hashtst-->
	...
	<!--RULE -->
<xsl:template match="ind-def:filehash_test/ind-def:object" priority="1001" mode="M59">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:filehash_test/ind-def:state" priority="1000" mode="M59">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_envstevalue-->
	...
	<!--RULE -->
<xsl:template match="ind-def:environmentvariable_state/ind-def:value" priority="1000"
                 mode="M62">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text/> - datatype attribute for the <xsl:text/>
            <xsl:value-of select="name()"/>
            <xsl:text/> entity of an <xsl:text/>
            <xsl:value-of select="name(..)"/>
            <xsl:text/> should not be 'record'<xsl:value-of select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M62"/>
   </xsl:template>
   ...
   <!--PATTERN ind-def_ldap_test_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:ldap_test" priority="1000" mode="M63">
...
<xsl:if test="true()">DEPRECATED TEST: <xsl:text/>
   ...
   <!--PATTERN ind-def_ldaptst-->
	...
	<!--RULE -->
<xsl:template match="ind-def:ldap_test/ind-def:object" priority="1001" mode="M64">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:ldap_test/ind-def:state" priority="1000" mode="M64">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_ldap_object_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:ldap_object" priority="1000" mode="M65">
...
<xsl:if test="true()">DEPRECATED OBJECT: <xsl:text/>
   ...
   <!--PATTERN ind-def_ldap_state_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:ldap_state" priority="1000" mode="M66">
...
<xsl:if test="true()">DEPRECATED STATE: <xsl:text/>
   ...
   <!--PATTERN ind-def_ldapsteldapvalue-->
	...
	<!--RULE -->
<xsl:template match="ind-def:ldap_state/ind-def:value" priority="1000" mode="M67">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_ldap57_test-->
	...
	<!--RULE -->
<xsl:template match="ind-def:ldap57_test/ind-def:object" priority="1001" mode="M68">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:ldap57_test/ind-def:state" priority="1000" mode="M68">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sql_test_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_test" priority="1000" mode="M69">
...
<xsl:if test="true()">DEPRECATED TEST: <xsl:text/>
   ...
   <!--PATTERN ind-def_sqltst-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_test/ind-def:object" priority="1001" mode="M70">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:sql_test/ind-def:state" priority="1000" mode="M70">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sql_object_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_object" priority="1000" mode="M71">
...
<xsl:if test="true()">DEPRECATED OBJECT: <xsl:text/>
   ...
   <!--PATTERN ind-def_sqlobjdengine-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_object/ind-def:engine" priority="1000" mode="M72">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sqlobjversion-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_object/ind-def:version" priority="1000" mode="M73">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sqlobjconnection_string-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_object/ind-def:connection_string" priority="1000" mode="M74">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sqlobjsql-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_object/ind-def:sql" priority="1000" mode="M75">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sql_state_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql_state" priority="1000" mode="M76">
...
<xsl:if test="true()">DEPRECATED STATE: <xsl:text/>
   ...
   <!--PATTERN ind-def_sql57_test-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql57_test/ind-def:object" priority="1001" mode="M77">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:sql57_test/ind-def:state" priority="1000" mode="M77">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sql57_object_dengine-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql57_object/ind-def:engine" priority="1000" mode="M78">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sql57_object_version-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql57_object/ind-def:version" priority="1000" mode="M79">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_sql57_object_sql-->
	...
	<!--RULE -->
<xsl:template match="ind-def:sql57_object/ind-def:sql" priority="1000" mode="M81">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:textfilecontent54_test/ind-def:state" priority="1000" mode="M82">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_txt54stesubexpression-->
	...
	<!--RULE -->
<xsl:template match="ind-def:textfilecontent54_state/ind-def:subexpression" priority="1000"
                 mode="M85">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_txttst_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:textfilecontent_test" priority="1000" mode="M86">
...
<xsl:if test="true()">
   ...
   <!--PATTERN ind-def_txttst-->
	...
	<!--RULE -->
<xsl:template match="ind-def:textfilecontent_test/ind-def:object" priority="1001" mode="M87">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:textfilecontent_test/ind-def:state" priority="1000" mode="M87">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_txtobj_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:textfilecontent_object" priority="1000" mode="M88">
...
<xsl:if test="true()">
   ...
   <!--PATTERN ind-def_txtobjline-->
	...
	<!--RULE -->
<xsl:template match="ind-def:textfilecontent_object/ind-def:line" priority="1000" mode="M89">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_txtste_dep-->
	...
	<!--RULE -->
<xsl:template match="ind-def:textfilecontent_state" priority="1000" mode="M90">
...
<xsl:if test="true()">
   ...
   <!--PATTERN ind-def_vattst-->
	...
	<!--RULE -->
<xsl:template match="ind-def:variable_test/ind-def:object" priority="1001" mode="M91">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:variable_test/ind-def:state" priority="1000" mode="M91">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_varobjvar_ref-->
	...
	<!--RULE -->
<xsl:template match="ind-def:variable_object/ind-def:var_ref" priority="1000" mode="M92">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_varstevar_ref-->
	...
	<!--RULE -->
<xsl:template match="ind-def:variable_state/ind-def:var_ref" priority="1000" mode="M93">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_xmltst-->
	...
	<!--RULE -->
<xsl:template match="ind-def:xmlfilecontent_test/ind-def:object" priority="1001" mode="M94">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ind-def:xmlfilecontent_test/ind-def:state" priority="1000" mode="M94">
...
<xsl:choose>
   ...
   <!--PATTERN ind-def_xmlobjxpath-->
	...
	<!--RULE -->
<xsl:template match="ind-def:xmlfilecontent_object/ind-def:xpath" priority="1000" mode="M96">
...
<xsl:if test=".='LDAPTYPE_EMAIL'">
   ...
   <!--PATTERN aix-def_interimfixtst-->
	...
	<!--RULE -->
<xsl:template match="aix-def:interim_fix_test/aix-def:object" priority="1001" mode="M99">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="aix-def:interim_fix_test/aix-def:state" priority="1000" mode="M99">
...
<xsl:choose>
   ...
   <!--PATTERN aix-def_filesettst-->
	...
	<!--RULE -->
<xsl:template match="aix-def:fileset_test/aix-def:object" priority="1001" mode="M100">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="aix-def:fileset_test/aix-def:state" priority="1000" mode="M100">
...
<xsl:choose>
   ...
   <!--PATTERN aix-def_fixtst-->
	...
	<!--RULE -->
<xsl:template match="aix-def:fix_test/aix-def:object" priority="1001" mode="M101">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="aix-def:fix_test/aix-def:state" priority="1000" mode="M101">
...
<xsl:choose>
   ...
   <!--PATTERN aix-def_osleveltst-->
	...
	<!--RULE -->
<xsl:template match="aix-def:oslevel_test/aix-def:object" priority="1001" mode="M102">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="aix-def:oslevel_test/aix-def:state" priority="1000" mode="M102">
...
<xsl:choose>
   ...
   <!--PATTERN apache-def_httpdtst-->
	...
	<!--RULE -->
<xsl:template match="apache-def:httpd_test/apache-def:object" priority="1001" mode="M103">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="apache-def:httpd_test/apache-def:state" priority="1000" mode="M103">
...
<xsl:choose>
   ...
   <!--PATTERN catos-def_linetst-->
	...
	<!--RULE -->
<xsl:template match="catos-def:line_test/catos-def:object" priority="1001" mode="M104">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="catos-def:line_test/catos-def:state" priority="1000" mode="M104">
...
<xsl:choose>
   ...
   <!--PATTERN catos-def_moduletst-->
	...
	<!--RULE -->
<xsl:template match="catos-def:module_test/catos-def:object" priority="1001" mode="M105">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="catos-def:module_test/catos-def:state" priority="1000" mode="M105">
...
<xsl:choose>
   ...
   <!--PATTERN catos-def_version55_test-->
	...
	<!--RULE -->
<xsl:template match="catos-def:version55_test/catos-def:object" priority="1001" mode="M106">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="catos-def:version55_test/catos-def:state" priority="1000" mode="M106">
...
<xsl:choose>
   ...
   <!--PATTERN catos-def_version_test_dep-->
	...
	<!--RULE -->
<xsl:template match="catos-def:version_test" priority="1000" mode="M107">
...
<xsl:if test="true()">
   ...
   <!--PATTERN catos-def_version_test-->
	...
	<!--RULE -->
<xsl:template match="catos-def:version_test/catos-def:object" priority="1001" mode="M108">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="catos-def:version_test/catos-def:state" priority="1000" mode="M108">
...
<xsl:choose>
   ...
   <!--PATTERN catos-def_version_object_dep-->
	...
	<!--RULE -->
<xsl:template match="catos-def:version_object" priority="1000" mode="M109">
...
<xsl:if test="true()">
   ...
   <!--PATTERN catos-def_version_state_dep-->
	...
	<!--RULE -->
<xsl:template match="catos-def:version_state" priority="1000" mode="M110">
...
<xsl:if test="true()">
   ...
   <!--PATTERN esx-def_patch56tst-->
	...
	<!--RULE -->
<xsl:template match="esx-def:patch56_test/esx-def:object" priority="1001" mode="M111">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="esx-def:patch56_test/esx-def:state" priority="1000" mode="M111">
...
<xsl:choose>
   ...
   <!--PATTERN esx-def_patchtst_dep-->
	...
	<!--RULE -->
<xsl:template match="esx-def:patch_test" priority="1000" mode="M112">
...
<xsl:if test="true()">DEPRECATED TEST: <xsl:text/>
   ...
   <!--PATTERN esx-def_patchtst-->
	...
	<!--RULE -->
<xsl:template match="esx-def:patch_test/esx-def:object" priority="1001" mode="M113">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="esx-def:patch_test/esx-def:state" priority="1000" mode="M113">
...
<xsl:choose>
   ...
   <!--PATTERN esx-def_patchobj_dep-->
	...
	<!--RULE -->
<xsl:template match="esx-def:patch_object" priority="1000" mode="M114">
...
<xsl:if test="true()">DEPRECATED OBJECT: <xsl:text/>
   ...
   <!--PATTERN esx-def_patchste_dep-->
	...
	<!--RULE -->
<xsl:template match="esx-def:patch_state" priority="1000" mode="M115">
...
<xsl:if test="true()">DEPRECATED STATE: <xsl:text/>
   ...
   <!--PATTERN esx-def_versiontst-->
	...
	<!--RULE -->
<xsl:template match="esx-def:version_test/esx-def:object" priority="1001" mode="M116">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="esx-def:version_test/esx-def:state" priority="1000" mode="M116">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="freebsd-def:portinfo_test/freebsd-def:state" priority="1000" mode="M117">
...
<xsl:choose>
   ...
   <!--PATTERN hpux-def_getconf_test-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:getconf_test/hpux-def:object" priority="1001" mode="M118">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="hpux-def:getconf_test/hpux-def:state" priority="1000" mode="M118">
...
<xsl:choose>
   ...
   <!--PATTERN hpux-def_patch53_test-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:patch53_test/hpux-def:object" priority="1001" mode="M119">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="hpux-def:patch53_test/hpux-def:state" priority="1000" mode="M119">
...
<xsl:choose>
   ...
   <!--PATTERN hpux-def_patch_test_dep-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:patch_test" priority="1000" mode="M120">
...
<xsl:if test="true()">
   ...
   <!--PATTERN hpux-def_patch_test-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:patch_test/hpux-def:object" priority="1001" mode="M121">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="hpux-def:patch_test/hpux-def:state" priority="1000" mode="M121">
...
<xsl:choose>
   ...
   <!--PATTERN hpux-def_patch_object_dep-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:patch_object" priority="1000" mode="M122">
...
<xsl:if test="true()">
   ...
   <!--PATTERN hpux-def_patch_state_dep-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:patch_state" priority="1000" mode="M123">
...
<xsl:if test="true()">
   ...
   <!--PATTERN hpux-def_swlist_test-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:swlist_test/hpux-def:object" priority="1001" mode="M124">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="hpux-def:swlist_test/hpux-def:state" priority="1000" mode="M124">
...
<xsl:choose>
   ...
   <!--PATTERN hpux-def_trusted_test-->
	...
	<!--RULE -->
<xsl:template match="hpux-def:trusted_test/hpux-def:object" priority="1001" mode="M125">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="hpux-def:trusted_test/hpux-def:state" priority="1000" mode="M125">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_globaltst-->
	...
	<!--RULE -->
<xsl:template match="ios-def:global_test/ios-def:object" priority="1001" mode="M126">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ios-def:global_test/ios-def:state" priority="1000" mode="M126">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_interfacetst-->
	...
	<!--RULE -->
<xsl:template match="ios-def:interface_test/ios-def:object" priority="1001" mode="M127">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ios-def:interface_test/ios-def:state" priority="1000" mode="M127">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_linetst-->
	...
	<!--RULE -->
<xsl:template match="ios-def:line_test/ios-def:object" priority="1001" mode="M128">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ios-def:line_test/ios-def:state" priority="1000" mode="M128">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_snmptst-->
	...
	<!--RULE -->
<xsl:template match="ios-def:snmp_test/ios-def:object" priority="1001" mode="M129">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ios-def:snmp_test/ios-def:state" priority="1000" mode="M129">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_tclshtst-->
	...
	<!--RULE -->
<xsl:template match="ios-def:tclsh_test/ios-def:object" priority="1001" mode="M130">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ios-def:tclsh_test/ios-def:state" priority="1000" mode="M130">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_ver55tst-->
	...
	<!--RULE -->
<xsl:template match="ios-def:version55_test/ios-def:object" priority="1001" mode="M131">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ios-def:version55_test/ios-def:state" priority="1000" mode="M131">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_vertst_dep-->
	...
	<!--RULE -->
<xsl:template match="ios-def:version_test" priority="1000" mode="M132">
...
<xsl:if test="true()">
   ...
   <!--PATTERN ios-def_vertst-->
	...
	<!--RULE -->
<xsl:template match="ios-def:version_test/ios-def:object" priority="1001" mode="M133">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ios-def:version_test/ios-def:state" priority="1000" mode="M133">
...
<xsl:choose>
   ...
   <!--PATTERN ios-def_verobj_dep-->
	...
	<!--RULE -->
<xsl:template match="ios-def:version_object" priority="1000" mode="M134">
...
<xsl:if test="true()">
   ...
   <!--PATTERN ios-def_verste_dep-->
	...
	<!--RULE -->
<xsl:template match="ios-def:version_state" priority="1000" mode="M135">
...
<xsl:if test="true()">
   ...
   <!--PATTERN linux-def_dpkginfo_test-->
	...
	<!--RULE -->
<xsl:template match="linux-def:dpkginfo_test/linux-def:object" priority="1001" mode="M136">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="linux-def:dpkginfo_test/linux-def:state" priority="1000" mode="M136">
...
<xsl:choose>
   ...
   <!--PATTERN linux-def_rpminfo_test-->
	...
	<!--RULE -->
<xsl:template match="linux-def:rpminfo_test/linux-def:object" priority="1001" mode="M138">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="linux-def:rpminfo_test/linux-def:state" priority="1000" mode="M138">
...
<xsl:choose>
   ...
   <!--PATTERN macos-def_accountinfo_test-->
	...
	<!--RULE -->
<xsl:template match="macos-def:accountinfo_test/macos-def:object" priority="1001" mode="M140">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="macos-def:accountinfo_test/macos-def:state" priority="1000" mode="M140">
...
<xsl:choose>
   ...
   <!--PATTERN macos-def_nvram_test-->
	...
	<!--RULE -->
<xsl:template match="macos-def:nvram_test/macos-def:object" priority="1001" mode="M142">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="macos-def:nvram_test/macos-def:state" priority="1000" mode="M142">
...
<xsl:choose>
   ...
   <!--PATTERN macos-def_pwpolicy_test-->
	...
	<!--RULE -->
<xsl:template match="macos-def:pwpolicy_test/macos-def:object" priority="1001" mode="M143">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="macos-def:pwpolicy_test/macos-def:state" priority="1000" mode="M143">
...
<xsl:choose>
   ...
   <!--PATTERN pixos-def_linetst-->
	...
	<!--RULE -->
<xsl:template match="pixos-def:line_test/pixos-def:object" priority="1001" mode="M146">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="pixos-def:line_test/pixos-def:state" priority="1000" mode="M146">
...
<xsl:choose>
   ...
   <!--PATTERN pixos-def_vertst-->
	...
	<!--RULE -->
<xsl:template match="pixos-def:version_test/pixos-def:object" priority="1001" mode="M147">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="pixos-def:version_test/pixos-def:state" priority="1000" mode="M147">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_webapptst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:spwebapplication_test/sp-def:object" priority="1001" mode="M148">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:spwebapplication_test/sp-def:state" priority="1000" mode="M148">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_grptst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:spgroup_test/sp-def:object" priority="1001" mode="M149">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:spgroup_test/sp-def:state" priority="1000" mode="M149">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_webtst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:spweb_test/sp-def:object" priority="1001" mode="M150">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:spweb_test/sp-def:state" priority="1000" mode="M150">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_listtst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:splist_test/sp-def:object" priority="1001" mode="M151">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:splist_test/sp-def:state" priority="1000" mode="M151">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_sitetst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:spsite_test/sp-def:object" priority="1001" mode="M154">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:spsite_test/sp-def:state" priority="1000" mode="M154">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_crtst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:spcrawlrule_test/sp-def:object" priority="1001" mode="M155">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:spcrawlrule_test/sp-def:state" priority="1000" mode="M155">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_jobdeftst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:spjobdefinition_test/sp-def:object" priority="1001" mode="M156">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:spjobdefinition_test/sp-def:state" priority="1000" mode="M156">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_bbtst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:bestbet_test/sp-def:object" priority="1001" mode="M157">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:bestbet_test/sp-def:state" priority="1000" mode="M157">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_infopolicycolltst-->
	...
	<!--RULE -->
<xsl:template match="sp-def:policycoll_test/sp-def:object" priority="1001" mode="M158">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:policycoll_test/sp-def:state" priority="1000" mode="M158">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:spdiagnosticslevel_test/sp-def:state" priority="1000" mode="M160">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_policyfeature_test-->
	...
	<!--RULE -->
<xsl:template match="sp-def:sppolicyfeature_test/sp-def:object" priority="1001" mode="M161">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:sppolicyfeature_test/sp-def:state" priority="1000" mode="M161">
...
<xsl:choose>
   ...
   <!--PATTERN sp-def_policy_test-->
	...
	<!--RULE -->
<xsl:template match="sp-def:sppolicy_test/sp-def:object" priority="1001" mode="M162">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sp-def:sppolicy_test/sp-def:state" priority="1000" mode="M162">
...
<xsl:choose>
   ...
   <!--PATTERN sol-def_isainfotst-->
	...
	<!--RULE -->
<xsl:template match="sol-def:isainfo_test/sol-def:object" priority="1001" mode="M163">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sol-def:isainfo_test/sol-def:state" priority="1000" mode="M163">
...
<xsl:choose>
   ...
   <!--PATTERN sol-def_packagetst-->
	...
	<!--RULE -->
<xsl:template match="sol-def:package_test/sol-def:object" priority="1001" mode="M164">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sol-def:package_test/sol-def:state" priority="1000" mode="M164">
...
<xsl:choose>
   ...
   <!--PATTERN sol-def_patch54tst-->
	...
	<!--RULE -->
<xsl:template match="sol-def:patch54_test/sol-def:object" priority="1001" mode="M165">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sol-def:patch54_test/sol-def:state" priority="1000" mode="M165">
...
<xsl:choose>
   ...
   <!--PATTERN sol-def_patchtst_dep-->
	...
	<!--RULE -->
<xsl:template match="sol-def:patch_test" priority="1000" mode="M166">
...
<xsl:if test="true()">
   ...
   <!--PATTERN sol-def_patchtst-->
	...
	<!--RULE -->
<xsl:template match="sol-def:patch_test/sol-def:object" priority="1001" mode="M167">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sol-def:patch_test/sol-def:state" priority="1000" mode="M167">
...
<xsl:choose>
   ...
   <!--PATTERN sol-def_patchobj_dep-->
	...
	<!--RULE -->
<xsl:template match="sol-def:patch_object" priority="1000" mode="M168">
...
<xsl:if test="true()">
   ...
   <!--PATTERN sol-def_smftst-->
	...
	<!--RULE -->
<xsl:template match="sol-def:smf_test/sol-def:object" priority="1001" mode="M169">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="sol-def:smf_test/sol-def:state" priority="1000" mode="M169">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_dnscachetst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:dnscache_test/unix-def:object" priority="1001" mode="M170">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:dnscache_test/unix-def:state" priority="1000" mode="M170">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_filetst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:file_test/unix-def:object" priority="1001" mode="M171">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:file_test/unix-def:state" priority="1000" mode="M171">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_fileobjfilepath-->
	...
	<!--RULE -->
<xsl:template match="unix-def:file_object/unix-def:filepath" priority="1000" mode="M172">
...
<xsl:if test="@recurse='none'"> DEPRECATED ATTRIBUTE VALUE IN: <xsl:text/>
   ...
   <!--PATTERN unix-def_inetdtst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:inetd_test/unix-def:object" priority="1001" mode="M174">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:inetd_test/unix-def:state" priority="1000" mode="M174">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_interfacetst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:interface_test/unix-def:object" priority="1001" mode="M175">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:interface_test/unix-def:state" priority="1000" mode="M175">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_passwordtst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:password_test/unix-def:object" priority="1001" mode="M176">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:password_test/unix-def:state" priority="1000" mode="M176">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_processtst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:process_test/unix-def:object" priority="1001" mode="M177">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:process_test/unix-def:state" priority="1000" mode="M177">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_runleveltst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:runlevel_test/unix-def:object" priority="1001" mode="M178">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:runlevel_test/unix-def:state" priority="1000" mode="M178">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_sccstst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:sccs_test/unix-def:object" priority="1001" mode="M179">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:sccs_test/unix-def:state" priority="1000" mode="M179">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_sccsobjfilepath-->
	...
	<!--RULE -->
<xsl:template match="unix-def:sccs_object/unix-def:filepath" priority="1000" mode="M180">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_recurse_value_sccs_dep-->


	<!--RULE -->
<xsl:template match="oval-def:oval_definitions/oval-def:objects/unix-def:sccs_object/unix-def:behaviors"
                 priority="1000"
                 mode="M181">
...
<xsl:if test="@recurse='none'"> DEPRECATED ATTRIBUTE VALUE IN: <xsl:text/>
   ...
   <!--PATTERN unix-def_shadowtst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:shadow_test/unix-def:object" priority="1001" mode="M182">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:shadow_test/unix-def:state" priority="1000" mode="M182">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_unametst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:uname_test/unix-def:object" priority="1001" mode="M183">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:uname_test/unix-def:state" priority="1000" mode="M183">
...
<xsl:choose>
   ...
   <!--PATTERN unix-def_xinetdtst-->
	...
	<!--RULE -->
<xsl:template match="unix-def:xinetd_test/unix-def:object" priority="1001" mode="M184">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="unix-def:xinetd_test/unix-def:state" priority="1000" mode="M184">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_affected_platform-->
	...
	<!--RULE -->
<xsl:template match="oval-def:affected[@family='windows']" priority="1000" mode="M185">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_attst-->
	...
	<!--RULE -->
<xsl:template match="win-def:accesstoken_test/win-def:object" priority="1001" mode="M186">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:accesstoken_test/win-def:state" priority="1000" mode="M186">
...
<xsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: win-def:accesstoken_object <xsl:value-of select="string('&#xA;')"/>
   ...
   <!--PATTERN win-def_activedirectory_test_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:activedirectory_test" priority="1000" mode="M188">
...
<xsl:if test="true()">DEPRECATED TEST: <xsl:text/>
   ...
   <!--PATTERN win-def_adtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:activedirectory_test/win-def:object" priority="1001" mode="M189">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:activedirectory_test/win-def:state" priority="1000" mode="M189">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_activedirectory_object_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:activedirectory_object" priority="1000" mode="M190">
...
<xsl:if test="true()">DEPRECATED OBJECT: <xsl:text/>
   ...
   <!--PATTERN win-def_activedirectory_state_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:activedirectory_state" priority="1000" mode="M191">
...
<xsl:if test="true()">DEPRECATED STATE: <xsl:text/>
   ...
   <!--PATTERN win-def_adstevalue-->


	<!--RULE -->
<xsl:template match="win-def:activedirectory_state/win-def:value" priority="1000" mode="M192">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:auditeventpolicy_test/win-def:state" priority="1000" mode="M194">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_dnscachetst-->
	...
	<!--RULE -->
<xsl:template match="win-def:dnscache_test/win-def:object" priority="1001" mode="M196">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:dnscache_test/win-def:state" priority="1000" mode="M196">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_filetst-->
	...
	<!--RULE -->
<xsl:template match="win-def:file_test/win-def:object" priority="1001" mode="M197">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:file_test/win-def:state" priority="1000" mode="M197">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_fileobjfilepath-->
	...
	<!--RULE -->
<xsl:template match="win-def:file_object/win-def:filepath" priority="1000" mode="M198">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_fileobjfilename-->
	...
	<!--RULE -->
<xsl:template match="win-def:file_object/win-def:filename" priority="1000" mode="M199">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_filestefilename-->
	...
	<!--RULE -->
<xsl:template match="win-def:file_state/win-def:filename" priority="1000" mode="M200">
...
<xsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileauditedpermissions53_object <xsl:value-of select="string('&#xA;')"/>
   ...
   <!--PATTERN win-def_faptst_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:fileauditedpermissions_test" priority="1000" mode="M206">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_fapobj_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:fileauditedpermissions_object" priority="1000" mode="M208">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_fapste_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:fileauditedpermissions_state" priority="1000" mode="M210">
...
<xsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileeffectiverights53_object <xsl:value-of select="string('&#xA;')"/>
   ...
   <!--PATTERN win-def_fertst_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:fileeffectiverights_test" priority="1000" mode="M218">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_ferobj_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:fileeffectiverights_object" priority="1000" mode="M220">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_ferste_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:fileeffectiverights_state" priority="1000" mode="M222">
...
<xsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileeffectiverights_object <xsl:value-of select="string('&#xA;')"/>
   ...
   <!--PATTERN win-def_grouptst-->
	...
	<!--RULE -->
<xsl:template match="win-def:group_test/win-def:object" priority="1001" mode="M225">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:group_test/win-def:state" priority="1000" mode="M225">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_groupsidtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:group_sid_test/win-def:object" priority="1001" mode="M226">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:group_sid_test/win-def:state" priority="1000" mode="M226">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wininterfacetst-->
	...
	<!--RULE -->
<xsl:template match="win-def:interface_test/win-def:object" priority="1001" mode="M227">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:interface_test/win-def:state" priority="1000" mode="M227">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_lptst-->
	...
	<!--RULE -->
<xsl:template match="win-def:lockoutpolicy_test/win-def:object" priority="1001" mode="M228">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:lockoutpolicy_test/win-def:state" priority="1000" mode="M228">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_metabasetst-->
	...
	<!--RULE -->
<xsl:template match="win-def:metabase_test/win-def:object" priority="1001" mode="M229">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:metabase_test/win-def:state" priority="1000" mode="M229">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_metabasestedata-->


	<!--RULE -->
<xsl:template match="win-def:metabase_state/win-def:data" priority="1000" mode="M230">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_pptst-->
	...
	<!--RULE -->
<xsl:template match="win-def:passwordpolicy_test/win-def:object" priority="1001" mode="M231">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:passwordpolicy_test/win-def:state" priority="1000" mode="M231">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_winporttst-->
	...
	<!--RULE -->
<xsl:template match="win-def:port_test/win-def:object" priority="1001" mode="M232">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:port_test/win-def:state" priority="1000" mode="M232">
...
<xsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: printereffectiverights_object <xsl:value-of select="string('&#xA;')"/>
   ...
   <!--PATTERN win-def_processtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:process_test/win-def:object" priority="1001" mode="M235">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:process_test/win-def:state" priority="1000" mode="M235">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_regtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:registry_test/win-def:object" priority="1001" mode="M236">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:registry_test/win-def:state" priority="1000" mode="M236">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_regobjkey-->
	...
	<!--RULE -->
<xsl:template match="win-def:registry_object/win-def:key" priority="1000" mode="M237">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_regstevalue-->


	<!--RULE -->
<xsl:template match="win-def:registry_state/win-def:value" priority="1000" mode="M238">
...
<xsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: regkeyauditedpermissions53_object <xsl:value-of select="string('&#xA;')"/>
   ...
   <!--PATTERN win-def_raptst_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:regkeyauditedpermissions_test" priority="1000" mode="M242">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_rapobj_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:regkeyauditedpermissions_object" priority="1000" mode="M244">
...
<xsl:if test="true()">
   ...
   <!--PATTERN win-def_rapste_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:regkeyauditedpermissions_state" priority="1000" mode="M245">
...
<xsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: regkeyeffectiverights53_object <xsl:value-of select="string('&#xA;')"/>
   ...
   <!--PATTERN win-def_rertst_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:regkeyeffectiverights_test" priority="1000" mode="M250">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_rerobj_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:regkeyeffectiverights_object" priority="1000" mode="M252">
...
<xsl:if test="true()">
   ...
   <!--PATTERN win-def_rerste_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:regkeyeffectiverights_state" priority="1000" mode="M253">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_srtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:sharedresource_test/win-def:object" priority="1001" mode="M256">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:sharedresource_test/win-def:state" priority="1000" mode="M256">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_sidtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:sid_test/win-def:object" priority="1001" mode="M257">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:sid_test/win-def:state" priority="1000" mode="M257">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_sidsidtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:sid_sid_test/win-def:object" priority="1001" mode="M258">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:sid_sid_test/win-def:state" priority="1000" mode="M258">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_uactst-->
	...
	<!--RULE -->
<xsl:template match="win-def:uac_test/win-def:object" priority="1001" mode="M259">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:uac_test/win-def:state" priority="1000" mode="M259">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_usertst-->
	...
	<!--RULE -->
<xsl:template match="win-def:user_test/win-def:object" priority="1001" mode="M260">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:user_test/win-def:state" priority="1000" mode="M260">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_usersid55tst-->
	...
	<!--RULE -->
<xsl:template match="win-def:user_sid55_test/win-def:object" priority="1001" mode="M261">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:user_sid55_test/win-def:state" priority="1000" mode="M261">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_usersidtst_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:user_sid_test" priority="1000" mode="M262">
...
<xsl:if test="true()">
   ...
   <!--PATTERN win-def_usersidtst-->
	...
	<!--RULE -->
<xsl:template match="win-def:user_sid_test/win-def:object" priority="1001" mode="M263">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:user_sid_test/win-def:state" priority="1000" mode="M263">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_usersidobj_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:user_sid_object" priority="1000" mode="M264">
...
<xsl:if test="true()">
   ...
   <!--PATTERN win-def_usersidste_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:user_sid_state" priority="1000" mode="M265">
...
<xsl:if test="true()">
   ...
   <!--PATTERN win-def_volumetst-->
	...
	<!--RULE -->
<xsl:template match="win-def:volume_test/win-def:object" priority="1001" mode="M266">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:volume_test/win-def:state" priority="1000" mode="M266">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wmitst_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi_test" priority="1000" mode="M267">
...
<xsl:if test="true()">DEPRECATED TEST: <xsl:text/>
   ...
   <!--PATTERN win-def_wmitst-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi_test/win-def:object" priority="1001" mode="M268">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:wmi_test/win-def:state" priority="1000" mode="M268">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wmiobj_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi_object" priority="1000" mode="M269">
...
<xsl:if test="true()">DEPRECATED OBJECT: <xsl:text/>
   ...
   <!--PATTERN win-def_wmiobjnamespace-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi_object/win-def:namespace" priority="1000" mode="M270">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wmiobjwql-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi_object/win-def:wql" priority="1000" mode="M271">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wmiste_dep-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi_state" priority="1000" mode="M272">
...
<xsl:if test="true()">DEPRECATED STATE: <xsl:text/>
   ...
   <!--PATTERN win-def_wmisteresult-->


	<!--RULE -->
<xsl:template match="win-def:wmi_state/win-def:result" priority="1000" mode="M273">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wmi57tst-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi57_test/win-def:object" priority="1001" mode="M274">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="win-def:wmi57_test/win-def:state" priority="1000" mode="M274">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wmi57objnamespace-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi57_object/win-def:namespace" priority="1000" mode="M275">
...
<xsl:choose>
   ...
   <!--PATTERN win-def_wmi57objwql-->
	...
	<!--RULE -->
<xsl:template match="win-def:wmi57_object/win-def:wql" priority="1000" mode="M276">
